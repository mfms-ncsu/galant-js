...
onconnect = function(e) {
  ...
  setTimeout(() => {
    port.postMessage({message: 'graph-update', name: 'Does not exist', graph: 'n a 0 0 label:From_Testing'});

    setTimeout(() => {
        port.postMessage({message: 'graph-update', name: 'New Graph1', graph: 'n a 0 0 label:Updated_From_Testing'});
      }, 1000);
  }, 500);
}
