...
import LayeredGraph from "../Graph/LayeredGraph";
import Node from "../GraphElement/Node";
import StandardGraph from "../Graph/StandardGraph";
...
export default class FileParser {
    ...
    #parseNode(graph, values) {
        ...
        this.#addNode(graph, x, y, id, attributes);
    }
     ...
     */
    #addNode(graph, x, y, nodeId, attributes) {
    ...
    #parseEdge(graph, values) {
        ...
        // Add the edge
        this.#addEdge(graph, source, target, attributes);
    }
