...
//thread handler demo is used for testing as the actual thread handler can't be tested. This is used in algorithm testing and wherever else thread handler is used to test
//create a test flag where if its a test then use thread handler demo, otherwise user thread handler 
