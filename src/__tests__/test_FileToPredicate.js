...
test("String to Predicate With Weights No Special Key/Value Pairs", () => {
    ...
    var directed = {}
    directed[1] = { 'source': 'a', 'target': 'b', 'weight': 20 }
    var undirected = {}
    undirected[2] = { 'source': 'a', 'target': 'a', 'weight': 20 }
    var graph = {}
    graph['node'] = nodes
...
test("String to Predicate Without Weights No Special Key/Value Pairs", () => {
    ...
    var directed = {}
    directed[1] = { 'source': 'a', 'target': 'b', 'weight': null }
    var undirected = {}
    undirected[2] = { 'source': 'a', 'target': 'a', 'weight': null }
    var graph = {}
    graph['node'] = nodes
    graph['directed'] = directed
    graph['undirected'] = undirected
...
test("String to Predicate With Weights And Special Key/Value Pairs", () => {
    ...
    var directed = {}
    directed[1] = { 'source': 'a', 'target': 'b', 'weight': 5, 'color': 'white'}
    var undirected = {}
    undirected[2] = { 'source': 'a', 'target': 'b', 'weight': 5, 'color': 'yellow' }
    var graph = {}
    graph['node'] = nodes
    graph['directed'] = directed
    graph['undirected'] = undirected
...
test("String to Predicate Without Weights But With Special Key/Value Pairs", () => {
    ...
    var directed = {}
    directed[1] = { 'source': 'a', 'target': 'b', 'weight': null, 'color': 'white'}
    var undirected = {}
    undirected[2] = { 'source': 'a', 'target': 'a', 'weight': null, 'color': 'yellow' }
    var graph = {}
    graph['node'] = nodes
    graph['directed'] = directed
    graph['undirected'] = undirected
