...
* (Galant 1) Maintaining a mapping between physical screen positions of nodes and logical positions recorded in a text file. This will facilitate the following
...
* (Galant 2) Edits to node/edge labels/weights do not work; nor does adding an edge or deleting a node that has incident edges; these are probably simple oversights.
